...
export function GoogleMeet(props: SVGProps<SVGSVGElement>) {
    return (
        <svg {...props} viewBox="0 0 622 512" fill="none" aria-hidden="true">
            <g clipPath="url(#google-meet-clip)">
