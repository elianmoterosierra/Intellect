...
import { SubjectButton } from './AddSubjectButton/SubjectButton';
    ...
    return (
        <section data-testid="add-task-section" className="p-4 md:p-10">
            <div className="">
                ...
                <div className="mb-5 mx-auto flex min-h-12 items-center justify-center gap-2">
                    <AddTaskButton courseId={courseId} />
                    {canManage && <SubjectButton courseId={courseId} />}
                </div>
                ...
                {canManage && (
                    <div className="bg-surface rounded-lg border border-line shadow-sm overflow-hidden max-w-2xl mx-auto mt-6">
                        <div className="px-4 py-2.5 border-b border-line bg-muted/50 flex items-center justify-center">
                            <h3 className="text-sm leading-5 font-semibold tracking-tight text-ink">
                                Materias del curso
                            </h3>
