...
export function AppBar({ activeSection, onToggleSearch, isSearchOpen, searchQuery, setSearchQuery, courseId, setSelectedTask }) {
    ...
    return (
        <>
            <header className="md:hidden sticky top-0 z-50 flex flex-col bg-[#f9f9ff] border-b border-[#c2c6d6]">
                ...
                {isSearchOpen && (
                    <div className="px-4 py-3 mobile-search-row relative">
