...
export function TaskSummary({ tasks }: TaskSummaryProps) {
    ...
    return (
        <div className="order-1 flex h-fit self-start flex-col justify-between rounded-xl bg-gradient-to-br from-[#2170e4] to-[#005ac2] p-6 text-[#fefcff] shadow-sm md:order-2 md:col-span-4">
            <div>
