...
export function DetailsModal({ task, courseId, onClose }) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Título centrado */}
                <div className="px-7 pt-6 pb-2 border-b border-[#edf0fa]">
                    <h2 className="text-center text-xl font-bold leading-7 text-[#191b23] break-words">
                        {task.title}
                    </h2>
                </div>
                ...
                <div className="space-y-4 px-7 py-5">
                    <div className="max-h-40 overflow-y-auto rounded-xl border border-[#cdd3e9] bg-[#f9faff] px-5 py-3">
                        <p className="text-[15px] leading-6 text-[#424754] break-words whitespace-pre-wrap">
                            {task.subtitle}
                        </p>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="w-full rounded-xl border border-[#cdd3e9] bg-[#f9faff] py-3 pl-11 pr-4 text-[15px] text-[#424754]">
                            {task.hour}
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        className={`flex w-full items-center gap-3 rounded-xl border px-5 py-3 text-left transition-all duration-200 active:scale-[0.98] ${
                                ...
                                : 'border-[#cdd3e9] bg-[#f9faff] text-[#424754] hover:bg-[#f3f5fc]'
                        }`}
                    >
                        <span
                            className={`flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full border-2 transition-all duration-200 ${
                                done ? 'border-green-600 bg-green-600' : 'border-[#c2c6d6] bg-transparent'
                            }`}
                        >
