        ...
        >
            ...
            >
                <div className="px-6 pt-6 pb-2">
                    <h3 className="text-lg font-bold text-ink">Confirmar contraseña</h3>
                    <p className="text-sm text-ink-faint mt-1">
                        Ingresa tu contraseña para editar <span className="font-semibold text-ink">{fieldLabel}</span>
                    </p>
                </div>
