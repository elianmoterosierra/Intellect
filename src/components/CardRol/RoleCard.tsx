...
export function RoleCard({ title, features = [] }: RoleCardProps) {
    return (
        <div className="flex-1 bg-surface p-8 rounded-2xl border border-gray-200 relative overflow-hidden">
            ...
            <ul className="flex flex-col mt-6 items-start gap-4 list-none">
                {features.map((feature, index) => (
                    <li key={index} className="flex gap-2 items-center text-sm text-ink-soft">
